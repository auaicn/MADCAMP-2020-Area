...
class HomeViewController: UIViewController, ARSCNViewDelegate {
        ...
        @IBAction func flashLight(_ sender: UIButton) {
            if sender.currentBackgroundImage == UIImage(systemName: "bolt") {
                sender.setBackgroundImage(UIImage(systemName: "bolt.fill"), for: UIControl.State.normal)
                toggleOn()
            }
            else {
                sender.setBackgroundImage(UIImage(systemName: "bolt"), for: UIControl.State.normal)
                toggleOff()
            }
        }
